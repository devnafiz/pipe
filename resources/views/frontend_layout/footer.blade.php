...
<div class="color-palate">
    ...
    <div class="various-color clearfix">
        <div class="colors-list">
            <span class="palate default-color active" data-theme-file="{{asset('front_end/css/color-themes/default-theme.css')}}"></span>
            <span class="palate green-color" data-theme-file="{{asset('front_end/css/color-themes/green-theme.css')}}"></span>
            <span class="palate blue-color" data-theme-file="{{asset('front_end/css/color-themes/blue-theme.css')}}"></span>
            <span class="palate orange-color" data-theme-file="{{asset('front_end/css/color-themes/orange-theme.css')}}"></span>
            <span class="palate purple-color" data-theme-file="{{asset('front_end/css/color-themes/purple-theme.css')}}"></span>
            <span class="palate teal-color" data-theme-file="{{asset('front_end/css/color-themes/teal-theme.css')}}"></span>
            <span class="palate brown-color" data-theme-file="{{asset('front_end/css/color-themes/brown-theme.css')}}"></span>
            <span class="palate redd-color" data-theme-file="{{asset('front_end/css/color-themes/redd-color.css')}}"></span>
			<span class="palate olive-color" data-theme-file="{{asset('front_end/css/color-themes/olive-theme.css')}}"></span>
            <span class="palate yellow-color" data-theme-file="{{asset('front_end/css/color-themes/yellow-theme.css')}}"></span>
            <span class="palate pink-color" data-theme-file="{{asset('front_end/css/color-themes/pink-theme.css')}}"></span>
            <span class="palate hotpink-color" data-theme-file="{{asset('front_end/css/color-themes/hotpink-color.css')}}"></span>
        </div>
    </div>
