   ...
   <!--Page Title-->
	...
	<section class="case-section alternate gallery-page-case">
		...
		<div class="col-12 col-md-8 col-lg-10 pb-5">
                    ...
                    <form action="{{url('/scrap')}}" method="POST" name="accountFrom" id="accountFrom">
                    	{{csrf_field()}}
                        <div class="card border-primary rounded-0">
                            <div class="card-header p-0">
                                <div class="bg-info text-white text-center py-2" style="background-color:#13b5ea!important;">
                                    <h3><i class="fa fa-envelope"></i> Scrap</h3>
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="scrap_type" name="scrap_type" placeholder="Scrap Type" required>
                                    </div>
                                </div>
